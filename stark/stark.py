...
def parse_args(args):
    ...
    parser.add_argument("--ignored_labels", default=None, type=str, help="Labels that contain these parsing tags will be counted but ignored in result representations.")
